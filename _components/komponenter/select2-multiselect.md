...
<div class="accordion-bordered">
  ...
  <div id="accordion-bordered-docs" aria-hidden="true" class="accordion-content">
    ...
    <p>På dette dokumentationssite er multiselect funktionaliteten en del af javascript filen <code>dkfds-vendor-examples.js</code>, denne fil har kun til formål at vise funktionaliteten på dette dokumentationsite, og skal ikke inkluderes i selve selvbetjeningsløsningen.</p>
