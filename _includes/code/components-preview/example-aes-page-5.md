...
<main class="container page-container">
    ...
    <div class="overflow-menu  overflow-menu--open-right ">
        ...
        <div class="overflow-menu-inner" id="overflow_steps" aria-hidden="true">
            ...
            <ul class='sidenav-list'>
                ...
                <li>
                    <a href='/dkfds-docs/pages/page-templates/AES-erstatningssag/aes-5' class='active'>
    ...
    <nav class="page-navigation">
        <a href="/dkfds-docs/pages/page-templates/AES-erstatningssag/aes-6" class="button button-primary">Næste</a>
        <a href="/dkfds-docs/pages/page-templates/AES-erstatningssag/aes-4" class="button button-ghost">Tilbage</a>
    </nav>
</main>
