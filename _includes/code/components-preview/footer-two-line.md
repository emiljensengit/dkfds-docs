--- 
permalink: /preview-components/footer-two-line.html
layout: iframed 
title: Footer-two-line.html
---
<footer>
    <div class="footer">
        <div class="container">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 footer-col">
                    <div class="align-text-left">
                        <ul class="unstyled-list">
                            <li><span class="h5 weight-semibold" title="Ansvarlig myndighed"
                                    aria-label="Ansvarlig myndighed">Undervisningsministeriet</span></li>
                            <li>
