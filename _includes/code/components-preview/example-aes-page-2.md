...
<main class="container page-container">
    ...
    <div class="overflow-menu  overflow-menu--open-right ">
        ...
        <div class="overflow-menu-inner" id="overflow_steps" aria-hidden="true">
            ...
            <ul class='sidenav-list'>
                ...
                <li>
                    <a href='/dkfds-docs/pages/page-templates/AES-erstatningssag/aes-2' class='active'>
    ...
    <div class="form-group input-disabled">
        ...
        <input class="form-input  input-width-m" placeholder="Svend Pedersen" id="id-company-contact"
            value="" name="Input til virksomhedens kontaktperson" type="text" disabled="disabled">
    </div>

    <br>
    <button href="#" class="button button-secondary">
        <svg class="icon-svg "><use xlink:href="#add"></use></svg> Vælg en anden
    ...
    <nav class="page-navigation">
        <a href="/dkfds-docs/pages/page-templates/AES-erstatningssag/aes-3" class="button button-primary">Næste</a>
        <a href="/dkfds-docs/pages/page-templates/AES-erstatningssag/aes-1" class="button button-ghost">Tilbage</a>
    </nav>
</main>
