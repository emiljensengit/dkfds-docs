                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <table class="table table--borderless table--compact table--responsive-headers mt-6">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="mt-4 mt-lg-0"><svg class="icon-svg " ><use xlink:href="#file"></use></svg>vedhæftfil-1.pdf</td>
                                    ...
                                    <tr>
                                        <td class="mt-4 mt-lg-0"><svg class="icon-svg " ><use xlink:href="#file"></use></svg>vedhæftfil-2.pdf</td>
                                        <td class="align-text-right mt-4 mt-lg-0"><a
                                                href="#" class="function-link link-right"><svg class="icon-svg " ><use xlink:href="#delete-outline"></use></svg></a></td>
                                    </tr>
                                    <tr>
                                        <td class="mt-4 mt-lg-0"><svg class="icon-svg " ><use xlink:href="#file"></use></svg>vedhæftfil-3.pdf</td>
                                        <td class="align-text-right mt-4 mt-lg-0"><a
                                                href="#" class="function-link link-right"><svg class="icon-svg " ><use xlink:href="#delete-outline"></use></svg></a></td>
                                    </tr>
                                </tbody>
