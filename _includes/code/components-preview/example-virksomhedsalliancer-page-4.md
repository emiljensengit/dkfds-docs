...
<main class="container page-container">
    ...
    <div class="mt-0">
        ...
        <div class="form-group">
            ...
            <span class="form-hint" id="input-hint-message-id-advisors">Navne skal skrives i samme rækkefølge, som landene er anført</span>
    ...
    <p class="mt-3 mb-4">Ønsker du at vedhæfte bilag til ansøgningen (det er muligt at vedhæfte op
        til 3 bilag)?</p>
