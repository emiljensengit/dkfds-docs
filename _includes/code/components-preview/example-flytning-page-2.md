...
<main class="container page-container">
    ...
    <h1>Personer</h1>
    <p class="font-lead">Her kan du vælge hvilke personer i din husstand
        du ønsker at anmelde flytning for. Din eventuelle ægtefælle og
    ...
    <a href="#" class="icon-link">Regler i forbindelse med flytning når vi
        har børn sammen<svg class="icon-svg "><use xlink:href="#open-in-new"></use></svg></a>
                        ...
                        <td>
                            <div class="form-group ">
                                <input id="id-person-1" type="checkbox"
                                    ...
                                    checked>
                                <label for="id-person-1" class="checkbox sr-only">Vælg
                                    Klaus Egegreen Hansen</label>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="form-group ">
                                <input id="id-person-2" type="checkbox"
                                    ...
                                    class="form-checkbox   ">
                                <label for="id-person-2" class="sr-only">Vælg
                                    Line Von Larsen</label>
                            </div>
                        </td>
    ...
    <div>
        <button class="button button-secondary"><svg class="icon-svg " ><use xlink:href="#add"></use></svg>Tilføj
            personer</button>
    </div>
