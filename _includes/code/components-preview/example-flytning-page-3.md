...
<main class="container page-container">
    ...
    <div class="overflow-menu  overflow-menu--open-right ">
        ...
        <div class="overflow-menu-inner" id="overflow_steps" aria-hidden="true">
            ...
            <ul class='sidenav-list'>
                ...
                <li>
                    <a href='/dkfds-docs/pages/page-templates/digital-flytning/flytning-3' class='active'>
                        3. Adresse
                    </a>
                </li>
                <li>
    ...
    <nav class="page-navigation">
        <a href="/dkfds-docs/pages/page-templates/digital-flytning/flytning-4" class="button button-primary">Næste</a>
        <a href="/dkfds-docs/pages/page-templates/digital-flytning/flytning-2" class="button button-ghost">Tilbage</a>
    </nav>
</main>
