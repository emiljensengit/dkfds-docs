...
<main class="container page-container">
    ...
    <button href="example-aes-page-8" class="button button-secondary">Tilføj
        dokument</button>
    <table class="table table--borderless table--compact table--responsive-headers mt-6">
        ...
        <tbody>
            <tr>
                <td class="mt-4 mt-lg-0 break-word w-percent-md-40"><svg class="icon-svg " ><use href="#file"></use></svg>prn1023152_journal.pdf</td>
                ...
                <td class="mt-4 mt-lg-0">
                    ...
                    <div class="form-group">
                        <label class="form-label sr-only" for="id-pagenumber">Angiv
                ...
                <td class="align-text-md-right mt-4 mt-lg-0"><a href="#"
                        class="function-link link-right" title="Slet fil"><svg class="icon-svg " ><use href="#delete-outline"></use></svg></a></td>
            </tr>
        </tbody>
    </table>
