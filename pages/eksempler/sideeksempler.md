...
description: Eksempler på forskellige sidetyper i en selvbetjeningsløsning
subnav:
...
<!-- SOLUTION 1 -->
<h2 class="heading" id="page-1">Opsummeringsside</h2>
...
<!-- SOLUTION 2 -->
<h2 class="heading" id="page-2">Kvitteringssider</h2>
<p>Se en eksemplarisk løsning, som demonstrerer hvordan en blanket kan opbygges med en klikbar tringuide</p>
<div class="row mt-5">
  <div class="col-12 col-sm-12 col-md-4 col-lg-4">
